...
export const getUserDetail = (id) => {
  return (dispatch) => {
    axios
      .get("https://my-json-server.typicode.com/Bang-ipin/mockend/users/" + id)
      .then(function (response) {
        dispatch({
...
export const postUserCreate = (data) => {
  return (dispatch) => {
    axios
      .post("https://my-json-server.typicode.com/Bang-ipin/mockend/users", data)
      .then(function (response) {
...
export const putUserUpdate = (data, id) => {
  return (dispatch) => {
    axios
      .put(
        "http://my-json-server.typicode.com/Bang-ipin/mockend/users/" + id,
        data
      )
      .then(function (response) {
        console.log(response);
